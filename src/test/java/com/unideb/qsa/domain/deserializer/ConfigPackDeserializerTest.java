...
public class ConfigPackDeserializerTest {
    ...
    public void deserialize() {
        ...
        assertTrue(actual.getConfigKeyToConfigDefinitionMap().entrySet().containsAll(expected.getConfigKeyToConfigDefinitionMap().entrySet()));
        assertTrue(actual.getConfigKeyToConfigDefinitionMap().keySet().containsAll(expected.getConfigKeyToConfigDefinitionMap().keySet()));
        assertTrue(actual.getConfigNameToConfigDefinitionsMap().keySet().containsAll(expected.getConfigNameToConfigDefinitionsMap().keySet()));
        assertTrue(actual.getConfigNameToConfigDefinitionsMap().keySet().containsAll(expected.getConfigNameToConfigDefinitionsMap().keySet()));
    }
