...
public class ConfigPackResolverConfiguration {
    ...
    public ConfigPackResolverConfiguration(List<String> configUris, int refreshRateInMinutes) {
        this.configDefinitionSource = new ConfigDefinitionSource(createCacheableConfigPackSource(configUris, refreshRateInMinutes));
    ...
    private ConfigPackSource createCacheableConfigPackSource(List<String> configUris, int refreshRateInMinutes) {
        return new CacheableConfigPackSource(createCompositeConfigPackSource(configUris), refreshRateInMinutes);
    }
